...
class OTP(models.Model):
    ...
    # ``unique=True`` was here previously, but with only 6 digits (10^6 space)
    # and lookups always scoped by user, a global-unique constraint just
    # produced eventual IntegrityErrors on generation. Uniqueness is not a
    # security property of the code — expiry + rate limiting are.
